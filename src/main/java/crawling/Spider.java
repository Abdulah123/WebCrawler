...
public class Spider extends WebCrawler {
    ...
    /**
     * The normalizeUrl is a method which has to normalize the URL and give the same domain
     *
     * @param link
     * @param domain
     * @return
     */
    public String normalizeUrl(String link, String domain) {
    ...
    /**
     * isExternalLink is method of type boolean to see if there is any links which are not related to our link
     *
     * @param link
     * @return
     */
    ...
    /**
     * configure method is to configure the url with the response
     *
     * @param response
     * @param url
